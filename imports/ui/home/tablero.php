 <!-- Statistics -->
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="widget-container small">
              <div class="heading">
                <i class="fa fa-signal"></i>Nuevos socios<i class="fa fa-list pull-right"></i><i class="fa fa-refresh pull-right"></i>
              </div>
              <div class="widget-content padded">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="widget-container fluid-height">
              <div class="heading">
                <i class="fa fa-bar-chart-o"></i>Grafica de area
              </div>
          ...
          <div class="col-md-6">
            <div class="widget-container scrollable chat" style="height: 427px;">
              <div class="heading">
                <i class="fa fa-comments"></i>Chat<i class="fa fa-smile-o pull-right"></i>
              </div>
              <div class="widget-content padded">
                <ul>
                  <li>
                    ...
                    <div class="bubble">
                      <a class="user-name" href="">Abelardo Lopez</a>
                      <p class="message">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.
                      </p>
                      <p class="time">
                        <strong>Hoy</strong>3:53 pm
                      </p>
                    </div>
                  </li>
                  <li class="current-user">
                    ...
                    <div class="bubble">
                      <a class="user-name" href="">Juan Lino PadrÃ³n</a>
                      <p class="message">
              ...
              <div class="post-message">
                <input class="form-control" placeholder="Escribe tu mensaje aqui..." type="text"><input type="submit" value="Enviar">
              </div>
            </div>
          </div>
          <!-- End Chat -->
        ...
        <div class="row">
          ...
          <div class="col-lg-5">
            <div class="widget-container fluid-height">
              <div class="heading">
                <i class="fa fa-bar-chart-o"></i>Grafica circular
              </div>
